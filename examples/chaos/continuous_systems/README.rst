...
forced/damped Duffing oscillator, the forced Van der Pol oscillator (Cartwright and Littlewood's coexisting
subharmonics and chaotic "bad" set), Chua's circuit (the double-scroll attractor), the restricted
