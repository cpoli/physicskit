...
:math:`|\Psi_m|^2` directly by Metropolis Monte Carlo via its "plasma
analogy," and extracting the correlation hole and incompressible-droplet
density profile that are its defining signatures.
